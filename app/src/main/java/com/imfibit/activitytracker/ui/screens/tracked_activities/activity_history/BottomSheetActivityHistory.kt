package com.imfibit.activitytracker.ui.screens.tracked_activities.activity_history
...
fun BottomSheetActivityHistory(
    ...
    BottomSheetActivityHistory(
        activity = activity,
        months = months,
        onDayClicked = { activity, date -> RecordNavigatorImpl.onDayClicked(navigation, activity, date) },
